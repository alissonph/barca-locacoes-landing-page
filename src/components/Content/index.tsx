...
export default function Content() {
  const { isScrollingToAboutUs, isScrollingToContact, finishScroll } = useHome();
    ...
    <div className={styles.container}>
      ...
      <div className={styles.cards}>
        <div className={styles.card}>
          <div>
            <p>
              A Barca Locações é uma empresa de locações de materias para festas e eventos
              (cadeiras, mesas, toalhas).
            </p>
            <p>
              Situada em Artur Nogueira, prestamos serviços para a própria cidade, para Cosmópolis,
              Engenheiro Coelho e Holambra (outras cidades sob consulta).
            </p>
            <p>Nossos produtos:</p>
            <ul>
              <li>Cadeiras com logotipo da empresa estampada, de alta qualidade.</li>
              <li>Mesas com logotipo da empresa estampada, de alta qualidade.</li>
